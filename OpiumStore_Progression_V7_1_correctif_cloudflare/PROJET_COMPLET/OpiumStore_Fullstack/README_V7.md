...
## Correctif V7.1 Cloudflare

Les migrations ne contiennent plus `BEGIN TRANSACTION`/`COMMIT`. Le déployeur nettoie également ces instructions avant `wrangler d1 execute`. La migration peut être relancée sans danger après un échec initial.
